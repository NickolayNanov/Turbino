...
using Turbino.Persistence;

namespace Turbino.Persistence.Migrations
{
    [DbContext(typeof(TurbinoDbContext))]
    [Migration("20200429055324_RatingToTour")]
    partial class RatingToTour
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Turbino.Domain.Entities.Review", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Turbino.Domain.Entities.TurbinoUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Turbino.Domain.Entities.TurbinoRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Turbino.Domain.Entities.TurbinoUser", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Turbino.Domain.Entities.Review", b =>
                {
                    b.HasOne("Turbino.Domain.Entities.TurbinoUser", "Author")
                        .WithMany("Reviews")
